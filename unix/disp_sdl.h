 ...
 * ---------------------------------------------------------------------------
 * $File: //depot/clipka/upov/unix/disp_sdl.h $
 * $Revision: #3 $
 * $Change: 5944 $
...
namespace pov_frontend
{
	...
	class UnixSDLDisplay : public UnixDisplay
	{
		public:
			...
			UnixSDLDisplay(unsigned int w, unsigned int h, GammaCurvePtr gamma, float glareDesaturation, vfeSession *session, bool visible);
