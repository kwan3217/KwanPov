...
class TracePixel : public Trace
{
    public:
        ...
        void operator()(DBL x, DBL y, DBL width, DBL height, RGBTColour& colour, unsigned int siblingRays = 0);
    private:
        // Focal blur data
        class FocalBlurData
        {
        ...
        void TraceRayWithFocalBlur(RGBTColour& colour, DBL x, DBL y, DBL width, DBL height, unsigned int siblingRays = 0);
