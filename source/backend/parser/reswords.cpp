...
const RESERVED_WORD Reserved_Words[LAST_TOKEN] = {
    ...
    {FURNISH_TOKEN, "furnsh"},
	{GDPOOL_TOKEN, "gdpool"},
	{CKCOV_TOKEN, "ckcov"},
	{CKGETCOV_TOKEN, "ckgetcov"},
	{SPKEZR_TOKEN, "spkezr"},
	{PXFORM_TOKEN, "pxform"},
	{SCE2C_TOKEN, "sce2c"},
	{CKGP_TOKEN, "ckgp"},
	...
	{ETCAL_TOKEN, "etcal"},
	{TIMOUT_TOKEN, "timout"},
    {XYZ2LLA_TOKEN, "xyz2lla"},
    {LLA2XYZ_TOKEN, "lla2xyz"},
    ...
    {MATRIX_TOKEN, "matrix"},
    {MAX_DISTANCE_TOKEN, "max_distance"},
